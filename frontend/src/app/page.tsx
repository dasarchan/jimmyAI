        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link href="/search">
                <Button className="bg-[#4285F4] hover:bg-[#3367D6] rounded-full text-lg px-8 py-6 shadow-lg shadow-[#4285F4]/10 transition-all hover:shadow-xl hover:shadow-[#4285F4]/20">
                  Start Your Review
